...
class ResConfigSettings(models.TransientModel):
    ...
    ai_invoice_provider = fields.Selection([
       ...
       config_parameter='ai_invoice_extractor.provider',
       help="Vyberte AI model použitý na vyťažovanie PDF faktúr.")

    ai_invoice_api_key = fields.Char(
        string="AI API Kľúč",
        config_parameter='ai_invoice_extractor.api_key',
    ...
    ai_invoice_auto_create_partner = fields.Boolean(
        ...
        default=True,
        config_parameter='ai_invoice_extractor.auto_create_partner',
    ...
    ai_invoice_auto_extract_on_upload = fields.Boolean(
        ...
        default=True,
        config_parameter='ai_invoice_extractor.auto_extract_on_upload',
